...
const RvjsUIProvider = (props) => {
  ...
  const [useTooltip, setUseTooltip] = b(props.useTooltip ?? true);
...
const Shell = (_props) => {
  ...
  return (() => {
    ...
    I(_el$3, () => props.body);
    J(() => _el$2.className = shellDesktop_bodyWrapper_recipe({
...
const Header$1 = (_props) => {
  ...
  return (() => {
    ...
    J(() => _el$2.className = header_content_recipe({
      deviceType: props.deviceType
    }));
    return _el$;
  })();
...
const HeaderName = (_props) => {
  ...
  return (() => {
    ...
    J((_p$) => {
      ...
      _v$2 !== _p$.t && We(_el$, "href", _p$.t = _v$2);
      return _p$;
    });
    return _el$;
  })();
...
var _tmpl$$6$1 = /* @__PURE__ */ ze(`<li tabindex=-1><a>`);
...
var _tmpl$$2$1 = /* @__PURE__ */ ze(`<div><div tabindex=1></div><div>`), _tmpl$2 = /* @__PURE__ */ ze(`<pre tabindex=-1><code>`), _tmpl$3 = /* @__PURE__ */ ze(`<code>`);
...
var _tmpl$$1$1 = /* @__PURE__ */ ze(`<div><div tabindex=-1><code>`);
...
const useContentHeading = status => {
  ...
  const [headingContexts, setHeadingContexts] = b([]);
