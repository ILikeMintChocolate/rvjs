...
var _tmpl$$w = /* @__PURE__ */ Xe(`<button>`);
...
var _tmpl$$v = /* @__PURE__ */ Xe(`<div tabindex=0><iframe>`);
const Iframe = (props) => {
  return (() => {
...
var image_wrapper_style = "zbupeh0";
var image_image_recipe = createRuntimeFn$1({ defaultClassName: "zbupeh1", variantClassNames: { isLoaded: { true: "zbupeh2", false: "zbupeh3" } }, defaultVariants: {}, compoundVariants: [] });
...
const useImageLoad = () => {
  const [isLoaded, setIsLoaded] = S(false);
  const onLoadHandler = () => {
    setIsLoaded(true);
  };
  return {
...
var _tmpl$$u = /* @__PURE__ */ Xe(`<div><img>`);
const Image = (_props) => {
  ...
  return (() => {
    ...
    _el$.className = image_wrapper_style;
    Ft(_el$2, "load", onLoadHandler);
    K((_p$) => {
      var _v$ = props.width ?? "auto", _v$2 = props.height ?? "auto", _v$3 = props.aspectRatio ?? "auto", _v$4 = props.src, _v$5 = props.alt, _v$6 = image_image_recipe({
        isLoaded: isLoaded()
      });
      ...
      _v$3 !== _p$.a && ((_p$.a = _v$3) != null ? _el$.style.setProperty("aspect-ratio", _v$3) : _el$.style.removeProperty("aspect-ratio"));
      _v$4 !== _p$.o && Ue(_el$2, "src", _p$.o = _v$4);
      _v$5 !== _p$.i && Ue(_el$2, "alt", _p$.i = _v$5);
      _v$6 !== _p$.n && (_el$2.className = _p$.n = _v$6);
      return _p$;
    });
    return _el$;
  })();
...
var __default__ = { color: { supportError: "var(--ie8oza25)" }, spacing: { "05": "var(--_1regh6m9)" } };
...
const HeaderMenuItem = (_props) => {
  ...
  return (() => {
    ...
    Ft(_el$2, "click", onAnchorClickHandler);
    $(_el$2, Ie(Text, {
      kind: "body-compact-01",
      color: "textSecondary",
      get className() {
...
const LinkCodeSnippet = (_props) => {
  ...
  return (() => {
    ...
    _el$2.innerHTML = highlightedCodeHTML;
    K((_p$) => {
      var _v$ = props.ariaLabel, _v$2 = props.href, _v$3 = [linkCodeSnippet_code_style, link_text_recipe({
        disabled: false,
        visited: visited()
      }), text_recipe({
        kind: "code-01"
...
var _tmpl$$x = /* @__PURE__ */ Xe(`<a tabindex=0>`);
const Link = (_props) => {
...
const isInLocalizerPage = pathname => {
        ...
        return [Ie(HeaderMenuButton, {
          ...
          get children() {
            return [Ie(HeaderMenuItem, {
              ...
              text: "localizer",
              get href() {
                return `#/${language()}/localizer/overview/gettingStarted`;
              },
              get isActive() {
                return isInLocalizerPage(pathname());
              }
            }), Ie(HeaderMenuItem, {
              get text() {
  ...
  return [Ie(SideNavMenu, {
    ...
    get children() {
      return [Ie(SideNavMenuItem, {
        ...
        get text() {
          return t('sideNav.coreJSX.overview.items.guide');
        },
        get href() {
          return `#/${language()}/core-jsx/overview/guide`;
        },
        get isActive() {
          return isPathIncluded('/core-jsx/overview/guide', pathname());
        },
        get depth() {
          return props.depth + 1;
        }
...
const LocalizerSideNav = props => {
  ...
  return [Ie(SideNavMenu, {
    get menuName() {
      return t('sideNav.localizer.overview.menuName');
    },
    defaultShow: true,
    get depth() {
      return props.depth;
    ...
    get children() {
      return Ie(SideNavMenuItem, {
        get text() {
          return t('sideNav.localizer.overview.items.gettingStarted');
        },
        get href() {
          return `#/${language()}/localizer/overview/gettingStarted`;
        },
        get isActive() {
          return isPathIncluded('/localizer/overview/gettingStarted', pathname());
        },
        get depth() {
          return props.depth + 1;
        }
    ...
    get menuName() {
      return t('sideNav.localizer.hook.menuName');
    },
    defaultShow: true,
    get depth() {
      return props.depth;
    ...
    get children() {
      return [Ie(SideNavMenuItem, {
        get text() {
          return t('sideNav.localizer.hook.items.useLocalizer');
        },
        get href() {
          return `#/${language()}/localizer/hook/useLocalizer`;
        },
        get isActive() {
          return isPathIncluded('/localizer/hook/useLocalizer', pathname());
        },
        get depth() {
          return props.depth + 1;
        }
        ...
        get text() {
          return t('sideNav.localizer.hook.items.t');
        },
        get href() {
          return `#/${language()}/localizer/hook/t`;
        },
        get isActive() {
          return isPathIncluded('/localizer/hook/t', pathname());
        },
        get depth() {
          return props.depth + 1;
        }
        ...
        get text() {
          return t('sideNav.localizer.hook.items.useLocale');
        },
        get href() {
          return `#/${language()}/localizer/hook/useLocale`;
        },
        get isActive() {
          return isPathIncluded('/localizer/hook/useLocale', pathname());
        },
        get depth() {
          return props.depth + 1;
        }
        ...
        get text() {
          return t('sideNav.localizer.hook.items.setLocale');
        },
        get href() {
          return `#/${language()}/localizer/hook/setLocale`;
        },
        get isActive() {
          return isPathIncluded('/localizer/hook/setLocale', pathname());
        },
        get depth() {
          return props.depth + 1;
        }
      ...
      return Ie(SideNavItems, {
        get children() {
          return [Ie(SideNavMenu, {
            ...
            get menuName() {
              return t('sideNav.localizer.menuName');
            },
            defaultShow: false,
            get children() {
              return Ie(LocalizerSideNav, {
                depth: 1
              });
            }
          }), Ie(SideNavLink, {
...
var _tmpl$$5 = /*#__PURE__*/Xe(`<div><div>`);
const Content = props => {
  return (() => {
    var _el$ = _tmpl$$5(),
...
var _tmpl$$4 = /*#__PURE__*/Xe(`<div><img alt="">`);
...
const useContentSuspenseScroll = status => {
  de(() => {
    if (status() === 'LOADED') {
      window.scrollTo({
        top: 0
...
const titleByPath = {
  ...
  '/ko/core-jsx/reactive/useGlobalState': 'useGlobalState | @rvjs/core 개발 문서',
  ...
  '/ko/ui-jsx/typography/inlineCodeSnippet': 'InlineCodeSnippet | @rvjs/ui 개발 문서',
  '/ko/ui-jsx/typography/linkCodeSnippet': 'LinkCodeSnippet | @rvjs/ui 개발 문서',
  '/ko/ui-jsx/typography/singleCodeSnippet': 'SingleCodeSnippet | @rvjs/ui 개발 문서',
  '/ko/ui-jsx/typography/multiCodeSnippet': 'MultiCodeSnippet | @rvjs/ui 개발 문서',
  ...
  '/ko/ui-jsx/shell/headerGlobalAction': 'HeaderGlobalAction | @rvjs/ui 개발 문서',
  ...
  '/ko/localizer/overview/gettingStarted': '시작하기 | @rvjs/localizer 개발 문서',
  ...
  '/ko/core-js/reactive/useGlobalState': 'useGlobalState | @rvjs/core 개발 문서',
  ...
  '/ko/ui-js/typography/inlineCodeSnippet': 'InlineCodeSnippet | @rvjs/ui 개발 문서',
  '/ko/ui-js/typography/linkCodeSnippet': 'LinkCodeSnippet | @rvjs/ui 개발 문서',
  '/ko/ui-js/typography/singleCodeSnippet': 'SingleCodeSnippet | @rvjs/ui 개발 문서',
  '/ko/ui-js/typography/multiCodeSnippet': 'MultiCodeSnippet | @rvjs/ui 개발 문서',
  ...
  '/ko/ui-js/shell/headerGlobalAction': 'HeaderGlobalAction | @rvjs/ui 개발 문서',
  ...
  '/ko/ui-js/util/renderComponentFromJSON': 'renderComponentFromJSON | @rvjs/ui 개발 문서',
...
const useRouter = () => {
  ...
  const updateTitle = pathname => {
    document.title = titleByPath[pathname] ?? 'rvjs 개발 문서 | SPA 개발 라이브러리';
  };
  tt(() => {
