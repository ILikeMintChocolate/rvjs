...
const d$1 = new _(), K = Symbol.for("RVJS_GET_STATE_IDENTIFIER"), G = Symbol.for("RVJS_SET_STATE_IDENTIFIER"), U = Symbol.for("RVJS_COMPONENT_IDENTIFIER"), W = Symbol.for(
...
), re = (e) => Array.isArray(e), Q = (e) => typeof e == "function", ie = (e) => e instanceof SVGElement, ce = (e) => e instanceof Node, le = (e) => typeof e == "boolean", x = (e) => typeof e == "function" && e.hasOwnProperty("$$typeof"), de = (e) => typeof e == "object" && e.hasOwnProperty("$$typeof"), fe = (e) => x(e) && e.$$typeof === K, p = (e) => de(e) && e.$$typeof === U, H = (e) => p(e) && e.$$componentType === W, he = (e) => x(e) && y, X = (e) => e instanceof HTMLElement, ae = (e) => e instanceof SVGElement, ue = (e) => e != null, R$1 = (e) => e.map((t) => p(t) ? t.getNodes() : t).flat(1 / 0), C$1 = (e) => Array.isArray(e) ? e : [e], me = (e) => class extends e {
  constructor(...t) {
    super(...t);
    i(this, "self");
    i(this, "parentNode");
  ...
  renderFn() {
    return C$1(this.self.componentFn());
  }
  getNodes() {
    const t = [];
    if (!this.self.isRendered)
      ...
      t.push(...R$1(this.self.childNodes));
    else {
  ...
  renderTree(t) {
    this.self.traverseChildren((n) => (!t && n === this.self || n.isRendered || (d$1.set(n), n.render(!0)), !0));
  }
  commit() {
...
let S$1 = class S extends Re(g$1) {
  constructor(...s) {
...
const Oe = (e) => class extends e {
  ...
  renderItem(t) {
    const n = new S$1(() => t, "BLOCK_COMPONENT");
  ...
  subscribeDependency() {
    a$1.set({
      ...
      effectFn: () => {
        a$1.clear();
        const t = d$1.get();
        d$1.set(this.self), this.self.render(!1), d$1.set(t);
      }
    }), this.self.is, a$1.clear();
  }
};
class ge extends Oe(g$1) {
  constructor(...s) {
...
const b = (e) => {
  ...
  subscribeDependency() {
    ...
    }), this.self.each, a$1.clear();
  }
};
class Fe extends Me(g$1) {
  constructor(...s) {
...
const De = (e) => class extends e {
  ...
  subscribeDependency() {
    ...
    }), this.self.by, a$1.clear();
  }
};
class _e extends De(g$1) {
  constructor(...s) {
...
const N = (e, s, t, n) => {
  ...
  const s = new ge(
    () => d$1.get().renderItem(C$1(e.children)),
    // @ts-ignore
    e.key
  );
...
const Z = (e, s = {}) => {
  let t;
  return he(e) ? t = e(s) : t = new S$1(() => e(s), s.key), t;
  ...
  subscribeDependency() {
    ...
    }), this.self.value, a$1.clear();
  }
};
class Ve extends He(g$1) {
  constructor(...s) {
...
const Je = (e) => {
  const s = new Fe(
    () => d$1.get().renderItems(e.children),
    // @ts-ignore
    e == null ? void 0 : e.key
  );
...
P.$$typeof = y;
const Rt = (e, s) => {
  p(s) ? (d$1.set(s), e.append(...s.getNodes()), s.renderTree(!0), s.commit(), d$1.clear()) : e.append(String(s));
}, qe = (e) => new Pe(
  () => {
    const { children: t } = e;
    return d$1.get().renderItems(C$1(t)), t;
  },
  // @ts-ignore
  e.key
);
qe.$$typeof = y;
const I = (e, s, t) => {
  s == null || le(s) || (re(s) ? Be(e, s, t) : Q(s) ? Ge(e, s, t) : p(s) ? Ke(e, s, t) : ce(s) ? L$1(e, s, t) : L$1(e, document.createTextNode(String(s)), t));
}, Be = (e, s, t) => {
  s.forEach((n) => {
    I(e, n, t);
  });
  ...
  const n = d$1.get();
  if (n && n.setParentChildRelation(s), d$1.set(s), s.parentNode = e, t) {
...
const gt = () => {
  ...
  d$1.get().setOnDestroyHandler(e);
}, Xe = (e) => {
  d$1.get().setOnMountHandler(e);
}, $ = (e, s) => {
  s.forEach((t) => {
    fe(t) && (a$1.set({
      component: d$1.get(),
  ...
  d$1.get().addUnsubscribeEffectHandler(() => {
...
const w = new _(), tt = (e) => st(e) ? "DYNAMIC" : nt(e) ? "ANY" : "STATIC", st = (e) => e.startsWith("/:", 0), nt = (e) => e === "*", ot = (e) => e.replace("/:", ""), B = (e) => e.replace("/", ""), D = (e) => {
  ...
  const s = {}, t = (n, o) => {
    o.forEach((r) => {
      ...
      N(r, "element", f, "getElement"), n[h] = f, l && t(c, C$1(l));
    });
  };
  return t(s, C$1(e)), s;
}, it = (e, s) => {
  ...
  const [s] = at(), [t, n] = b(null), o = rt(C$1(e.children));
  let r = [];
  return $(() => {
...
const g = (e) => e.length === 5 && e[2] == "-", f = (e) => e.split("-"), d = (e, t) => {
  const s = t.split(".");
  let r = e;
  for (const c of s)
    r = r[c];
  ...
  if (g(e)) {
    const [s, r] = f(e);
    return t.resources[s].countries[r];
  } else
    return t.resources[e].default;
}, L = (e) => {
  const { resources: t } = e, s = [];
  for (const r in t) {
    s.push(r);
    const { countries: c } = t[r];
    for (const o in c)
      s.push(`${r}-${o}`);
  }
  return s;
  ...
  return e ? e.split(" ") : navigator.languages ? [...navigator.languages] : [navigator.language];
}, h = (e, t) => {
  var s, r;
  for (const c of e)
    if (g(c)) {
      const [o, u] = f(c);
      if ((s = t.resources[o]) != null && s.countries[u])
        return c;
    } else if ((r = t.resources[c]) != null && r.default)
      return c;
  return t.defaultLanguage;
};
let n = null;
const C = (e) => {
  const t = S(), s = h(t, e), r = new Set(L(e)), [c, o] = b(s), [u, i] = b(a(c(), e));
  n = {
    option: e,
    locale: c,
    setLocale: o,
  ...
  const { setLocale: t, localeSet: s } = n;
  s.has(e) && t(e);
};
  ...
  return Z(Header$1, {
    get children() {
      return [Z(HeaderMenuButton, {
        ...
        get href() {
          return `/${locale()}/core-jsx/overview/gettingStarted`;
        },
        get prefix() {
          return m('header.prefix');
        }
        ...
        get children() {
          return [Z(HeaderMenuItem, {
            ...
            text: "ui-jsx",
            get href() {
              return `/${locale()}/ui-jsx/overview/gettingStarted`;
            },
            get isActive() {
            ...
            get menuName() {
              return m('header.items.legacy');
            },
            get children() {
              return [Z(SubMenuItem, {
                text: "core-js",
                get href() {
                  return `/${locale()}/core-js/overview/gettingStarted`;
                },
                get isActive() {
                ...
                text: "ui-js",
                get href() {
                  return `/${locale()}/ui-js/overview/gettingStarted`;
                },
                get isActive() {
                ...
                text: "is-js",
                get href() {
                  return `/${locale()}/is-js/overview/gettingStarted`;
                },
                get isActive() {
        ...
        get children() {
          return [Z(SubMenu, {
            get menuName() {
              return m('header.items.language');
            },
            get children() {
              return Z(SubMenuItem, {
                text: "\uD55C\uAD6D\uC5B4",
      ...
      return Z(SideNavItems, {
        get children() {
          return [Z(SideNavMenu, {
            get menuName() {
              return m('sideNav.coreJS.overview.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                get text() {
                  return m('sideNav.coreJS.overview.items.gettingStarted');
                },
                get href() {
                  return `/${locale()}/core-js/overview/gettingStarted`;
                },
                ...
                get text() {
                  return m('sideNav.coreJS.overview.items.guide');
                },
                get href() {
                  return `/${locale()}/core-js/overview/guide`;
                },
                get isActive() {
                ...
                get text() {
                  return m('sideNav.coreJS.overview.items.benchmark');
                },
                get href() {
                  return `/${locale()}/core-js/overview/benchmark`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.coreJS.render.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "element",
                get href() {
                  return `/${locale()}/core-js/dom/element`;
                },
                get isActive() {
                ...
                text: "component",
                get href() {
                  return `/${locale()}/core-js/dom/component`;
                },
                get isActive() {
                ...
                text: "root",
                get href() {
                  return `/${locale()}/core-js/dom/root`;
                },
                get isActive() {
                ...
                text: "textNode",
                get href() {
                  return `/${locale()}/core-js/dom/textNode`;
                },
                get isActive() {
                ...
                text: "Switch",
                get href() {
                  return `/${locale()}/core-js/dom/switch`;
                },
                get isActive() {
                ...
                text: "Toggle",
                get href() {
                  return `/${locale()}/core-js/dom/toggle`;
                },
                get isActive() {
                ...
                text: "Suspense",
                get href() {
                  return `/${locale()}/core-js/dom/suspense`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.coreJS.reactive.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "useState",
                get href() {
                  return `/${locale()}/core-js/reactive/useState`;
                },
                get isActive() {
                ...
                text: "useGlobalState",
                get href() {
                  return `/${locale()}/core-js/reactive/useGlobalState`;
                },
                get isActive() {
                ...
                text: "useEffect",
                get href() {
                  return `/${locale()}/core-js/reactive/useEffect`;
                },
                get isActive() {
                ...
                text: "useRef",
                get href() {
                  return `/${locale()}/core-js/reactive/useRef`;
                },
                get isActive() {
                ...
                text: "useElement",
                get href() {
                  return `/${locale()}/core-js/reactive/useElement`;
                },
                get isActive() {
                ...
                text: "dynamic",
                get href() {
                  return `/${locale()}/core-js/reactive/dynamic`;
                },
                get isActive() {
                ...
                text: "prop",
                get href() {
                  return `/${locale()}/core-js/reactive/prop`;
                },
                get isActive() {
                ...
                text: "createContext",
                get href() {
                  return `/${locale()}/core-js/reactive/createContext`;
                },
                get isActive() {
                ...
                text: "onMount",
                get href() {
                  return `/${locale()}/core-js/reactive/onMount`;
                },
                get isActive() {
                ...
                text: "onDestroy",
                get href() {
                  return `/${locale()}/core-js/reactive/onDestroy`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.coreJS.router.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "Router",
                get href() {
                  return `/${locale()}/core-js/router/router`;
                },
                get isActive() {
                ...
                text: "useNavigate",
                get href() {
                  return `/${locale()}/core-js/router/useNavigate`;
                },
                get isActive() {
                ...
                text: "useOutlet",
                get href() {
                  return `/${locale()}/core-js/router/useOutlet`;
                },
                get isActive() {
                ...
                text: "usePathname",
                get href() {
                  return `/${locale()}/core-js/router/usePathname`;
                },
                get isActive() {
                ...
                text: "usePathEffect",
                get href() {
                  return `/${locale()}/core-js/router/usePathEffect`;
                },
                get isActive() {
                ...
                text: "usePathParams",
                get href() {
                  return `/${locale()}/core-js/router/usePathParams`;
                },
                get isActive() {
                ...
                text: "useQueryParams",
                get href() {
                  return `/${locale()}/core-js/router/useQueryParams`;
                },
                get isActive() {
    ...
    get children() {
      return Z(SideNavItems, {
        get children() {
          return [Z(SideNavMenu, {
            get menuName() {
              return m('sideNav.coreJSX.overview.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                get text() {
                  return m('sideNav.coreJSX.overview.items.gettingStarted');
                },
                get href() {
                  return `/${locale()}/core-jsx/overview/gettingStarted`;
                },
                ...
                get text() {
                  return m('sideNav.coreJSX.overview.items.benchmark');
                },
                get href() {
                  return `/${locale()}/core-jsx/overview/benchmark`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.coreJSX.render.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "element",
                get href() {
                  return `/${locale()}/core-jsx/render/element`;
                },
                get isActive() {
                ...
                text: "root",
                get href() {
                  return `/${locale()}/core-jsx/render/root`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.coreJSX.component.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "For",
                get href() {
                  return `/${locale()}/core-jsx/component/for`;
                },
                get isActive() {
                ...
                text: "Switch / Case",
                get href() {
                  return `/${locale()}/core-jsx/component/switchCase`;
                },
                get isActive() {
                ...
                text: "Toggle",
                get href() {
                  return `/${locale()}/core-jsx/component/toggle`;
                },
                get isActive() {
                ...
                text: "Refresh",
                get href() {
                  return `/${locale()}/core-jsx/component/refresh`;
                },
                get isActive() {
                ...
                text: "Tag",
                get href() {
                  return `/${locale()}/core-jsx/component/tag`;
                },
                get isActive() {
                ...
                text: "Defined",
                get href() {
                  return `/${locale()}/core-jsx/component/defined`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.coreJSX.reactive.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "useState",
                get href() {
                  return `/${locale()}/core-jsx/reactive/useState`;
                },
                get isActive() {
                ...
                text: "useGlobalState",
                get href() {
                  return `/${locale()}/core-jsx/reactive/useGlobalState`;
                },
                get isActive() {
                ...
                text: "useEffect",
                get href() {
                  return `/${locale()}/core-jsx/reactive/useEffect`;
                },
                get isActive() {
                ...
                text: "useElement",
                get href() {
                  return `/${locale()}/core-jsx/reactive/useElement`;
                },
                get isActive() {
                ...
                text: "createContext",
                get href() {
                  return `/${locale()}/core-jsx/reactive/createContext`;
                },
                get isActive() {
                ...
                text: "onMount",
                get href() {
                  return `/${locale()}/core-jsx/reactive/onMount`;
                },
                get isActive() {
                ...
                text: "onDestroy",
                get href() {
                  return `/${locale()}/core-jsx/reactive/onDestroy`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.coreJSX.router.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "Router",
                get href() {
                  return `/${locale()}/core-jsx/router/router`;
                },
                get isActive() {
                ...
                text: "Route",
                get href() {
                  return `/${locale()}/core-jsx/router/route`;
                },
                get isActive() {
                ...
                text: "useNavigate",
                get href() {
                  return `/${locale()}/core-jsx/router/useNavigate`;
                },
                get isActive() {
                ...
                text: "useOutlet",
                get href() {
                  return `/${locale()}/core-jsx/router/useOutlet`;
                },
                get isActive() {
                ...
                text: "usePathname",
                get href() {
                  return `/${locale()}/core-jsx/router/usePathname`;
                },
                get isActive() {
                ...
                text: "usePathParams",
                get href() {
                  return `/${locale()}/core-jsx/router/usePathParams`;
                },
                get isActive() {
                ...
                text: "useQueryParams",
                get href() {
                  return `/${locale()}/core-jsx/router/useQueryParams`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.coreJSX.util.menuName');
            },
            defaultShow: true,
            get children() {
              return Z(SideNavMenuItem, {
                text: "defineProps",
                get href() {
                  return `/${locale()}/core-jsx/util/defineProps`;
                },
                get isActive() {
    ...
    get children() {
      return Z(SideNavItems, {
        get children() {
          return [Z(SideNavMenu, {
            get menuName() {
              return m('sideNav.isJS.overview.menuName');
            },
            defaultShow: true,
            get children() {
              return Z(SideNavMenuItem, {
                get text() {
                  return m('sideNav.isJS.overview.items.gettingStarted');
                },
                get href() {
                  return `/${locale()}/is-js/overview/gettingStarted`;
                },
            ...
            get menuName() {
              return m('sideNav.isJS.type.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                get text() {
                  return m('sideNav.isJS.type.items.primitive');
                },
                get href() {
                  return `/${locale()}/is-js/type/primitive`;
                },
                get isActive() {
                ...
                get text() {
                  return m('sideNav.isJS.type.items.reference');
                },
                get href() {
                  return `/${locale()}/is-js/type/reference`;
                },
                get isActive() {
                ...
                get text() {
                  return m('sideNav.isJS.type.items.composite');
                },
                get href() {
                  return `/${locale()}/is-js/type/composite`;
                },
                get isActive() {
                ...
                get text() {
                  return m('sideNav.isJS.type.items.@rvjs/core');
                },
                get href() {
                  return `/${locale()}/is-js/type/rvjs-core`;
                },
                get isActive() {
    ...
    get children() {
      return Z(SideNavItems, {
        get children() {
          return [Z(SideNavMenu, {
            get menuName() {
              return m('sideNav.uiJS.overview.menuName');
            },
            defaultShow: true,
            get children() {
              return Z(SideNavMenuItem, {
                get text() {
                  return m('sideNav.uiJS.overview.items.gettingStarted');
                },
                get href() {
                  return `/${locale()}/ui-js/overview/gettingStarted`;
                },
            ...
            get menuName() {
              return m('sideNav.uiJS.cssVars.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "color",
                get href() {
                  return `/${locale()}/ui-js/vars/color`;
                },
                get isActive() {
                ...
                text: "opacity",
                get href() {
                  return `/${locale()}/ui-js/vars/opacity`;
                },
                get isActive() {
                ...
                text: "spacing",
                get href() {
                  return `/${locale()}/ui-js/vars/spacing`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJS.layout.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "Box",
                get href() {
                  return `/${locale()}/ui-js/layout/box`;
                },
                get isActive() {
                ...
                text: "Flex",
                get href() {
                  return `/${locale()}/ui-js/layout/flex`;
                },
                get isActive() {
                ...
                text: "Grid",
                get href() {
                  return `/${locale()}/ui-js/layout/grid`;
                },
                get isActive() {
                ...
                text: "Section",
                get href() {
                  return `/${locale()}/ui-js/layout/section`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJS.form.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "Button",
                get href() {
                  return `/${locale()}/ui-js/form/button`;
                },
                get isActive() {
                ...
                text: "TextInput",
                get href() {
                  return `/${locale()}/ui-js/form/textInput`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJS.typography.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "Text",
                get href() {
                  return `/${locale()}/ui-js/typography/text`;
                },
                get isActive() {
                ...
                text: "Highlight",
                get href() {
                  return `/${locale()}/ui-js/typography/highlight`;
                },
                get isActive() {
                ...
                text: "Link",
                get href() {
                  return `/${locale()}/ui-js/typography/link`;
                },
                get isActive() {
                ...
                get href() {
                  return `/${locale()}/ui-js/typography/inlineCodeSnippet`;
                },
                get isActive() {
                ...
                get href() {
                  return `/${locale()}/ui-js/typography/linkCodeSnippet`;
                },
                get isActive() {
                ...
                get href() {
                  return `/${locale()}/ui-js/typography/singleCodeSnippet`;
                },
                get isActive() {
                ...
                get href() {
                  return `/${locale()}/ui-js/typography/multiCodeSnippet`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJS.content.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "ColorChip",
                get href() {
                  return `/${locale()}/ui-js/content/colorChip`;
                },
                get isActive() {
                ...
                text: "Icon",
                get href() {
                  return `/${locale()}/ui-js/content/icon`;
                },
                get isActive() {
                ...
                text: "Iframe",
                get href() {
                  return `/${locale()}/ui-js/content/iframe`;
                },
                get isActive() {
                ...
                text: "OrderedList",
                get href() {
                  return `/${locale()}/ui-js/content/orderedList`;
                },
                get isActive() {
                ...
                text: "UnorderedList",
                get href() {
                  return `/${locale()}/ui-js/content/unorderedList`;
                },
                get isActive() {
                ...
                text: "ListItem",
                get href() {
                  return `/${locale()}/ui-js/content/listItem`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJS.shell.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "Body",
                get href() {
                  return `/${locale()}/ui-js/shell/body`;
                },
                get isActive() {
                ...
                text: "Header",
                get href() {
                  return `/${locale()}/ui-js/shell/header`;
                },
                get isActive() {
                ...
                get href() {
                  return `/${locale()}/ui-js/shell/headerGlobalAction`;
                },
                get isActive() {
                ...
                get href() {
                  return `/${locale()}/ui-js/shell/headerGlobalBar`;
                },
                get isActive() {
                ...
                text: "HeaderHr",
                get href() {
                  return `/${locale()}/ui-js/shell/headerHr`;
                },
                get isActive() {
                ...
                get href() {
                  return `/${locale()}/ui-js/shell/headerMenuButton`;
                },
                get isActive() {
                ...
                text: "HeaderMenuItem",
                get href() {
                  return `/${locale()}/ui-js/shell/headerMenuItem`;
                },
                get isActive() {
                ...
                text: "HeaderName",
                get href() {
                  return `/${locale()}/ui-js/shell/headerName`;
                },
                get isActive() {
                ...
                get href() {
                  return `/${locale()}/ui-js/shell/headerNavigation`;
                },
                get isActive() {
                ...
                text: "SubMenu",
                get href() {
                  return `/${locale()}/ui-js/shell/subMenu`;
                },
                get isActive() {
                ...
                text: "SubMenuItem",
                get href() {
                  return `/${locale()}/ui-js/shell/subMenuItem`;
                },
                get isActive() {
                ...
                text: "SideNav",
                get href() {
                  return `/${locale()}/ui-js/shell/sideNav`;
                },
                get isActive() {
                ...
                text: "SideNavItems",
                get href() {
                  return `/${locale()}/ui-js/shell/sideNavItems`;
                },
                get isActive() {
                ...
                text: "SideNavLink",
                get href() {
                  return `/${locale()}/ui-js/shell/sideNavLink`;
                },
                get isActive() {
                ...
                text: "SideNavMenu",
                get href() {
                  return `/${locale()}/ui-js/shell/sideNavMenu`;
                },
                get isActive() {
                ...
                get href() {
                  return `/${locale()}/ui-js/shell/sideNavMenuItem`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJS.overlay.menuName');
            },
            defaultShow: true,
            get children() {
              return Z(SideNavMenuItem, {
                text: "Tooltip",
                get href() {
                  return `/${locale()}/ui-js/overlay/tooltip`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJS.util.menuName');
            },
            defaultShow: true,
            get children() {
              return Z(SideNavMenuItem, {
                ...
                get href() {
                  return `/${locale()}/ui-js/util/renderComponentFromJSON`;
                },
                get isActive() {
    ...
    get children() {
      return Z(SideNavItems, {
        get children() {
          return [Z(SideNavMenu, {
            get menuName() {
              return m('sideNav.uiJSX.overview.menuName');
            },
            defaultShow: true,
            get children() {
              return Z(SideNavMenuItem, {
                get text() {
                  return m('sideNav.uiJSX.overview.items.gettingStarted');
                },
                get href() {
                  return `/${locale()}/ui-jsx/overview/gettingStarted`;
                },
            ...
            get menuName() {
              return m('sideNav.uiJSX.cssVars.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "color",
                get href() {
                  return `/${locale()}/ui-jsx/vars/color`;
                },
                get isActive() {
                ...
                text: "font",
                get href() {
                  return `/${locale()}/ui-jsx/vars/font`;
                },
                get isActive() {
                ...
                text: "opacity",
                get href() {
                  return `/${locale()}/ui-jsx/vars/opacity`;
                },
                get isActive() {
                ...
                text: "spacing",
                get href() {
                  return `/${locale()}/ui-jsx/vars/spacing`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJSX.layout.menuName');
            },
            defaultShow: true,
            get children() {
              return Z(SideNavMenuItem, {
                text: "Section",
                get href() {
                  return `/${locale()}/ui-jsx/layout/section`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJSX.form.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "Button",
                get href() {
                  return `/${locale()}/ui-jsx/form/button`;
                },
                get isActive() {
                ...
                text: "TextInput",
                get href() {
                  return `/${locale()}/ui-jsx/form/textInput`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJSX.typography.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "Text",
                get href() {
                  return `/${locale()}/ui-jsx/typography/text`;
                },
                get isActive() {
                ...
                text: "Highlight",
                get href() {
                  return `/${locale()}/ui-jsx/typography/highlight`;
                },
                get isActive() {
                ...
                text: "Link",
                get href() {
                  return `/${locale()}/ui-jsx/typography/link`;
                },
                get isActive() {
                ...
                text: "InlineCodeSnippet",
                get href() {
                  return `/${locale()}/ui-jsx/typography/inlineCodeSnippet`;
                },
                get isActive() {
                ...
                text: "LinkCodeSnippet",
                get href() {
                  return `/${locale()}/ui-jsx/typography/linkCodeSnippet`;
                },
                get isActive() {
                ...
                text: "SingleCodeSnippet",
                get href() {
                  return `/${locale()}/ui-jsx/typography/singleCodeSnippet`;
                },
                get isActive() {
                ...
                text: "MultiCodeSnippet",
                get href() {
                  return `/${locale()}/ui-jsx/typography/multiCodeSnippet`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJSX.content.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "ColorChip",
                get href() {
                  return `/${locale()}/ui-jsx/content/colorChip`;
                },
                get isActive() {
                ...
                text: "Icon",
                get href() {
                  return `/${locale()}/ui-jsx/content/icon`;
                },
                get isActive() {
                ...
                text: "Iframe",
                get href() {
                  return `/${locale()}/ui-jsx/content/iframe`;
                },
                get isActive() {
                ...
                text: "OrderedList",
                get href() {
                  return `/${locale()}/ui-jsx/content/orderedList`;
                },
                get isActive() {
                ...
                text: "UnorderedList",
                get href() {
                  return `/${locale()}/ui-jsx/content/unorderedList`;
                },
                get isActive() {
                ...
                text: "ListItem",
                get href() {
                  return `/${locale()}/ui-jsx/content/listItem`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJSX.shell.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "Shell",
                get href() {
                  return `/${locale()}/ui-jsx/shell/shell`;
                },
                get isActive() {
                ...
                text: "Body",
                get href() {
                  return `/${locale()}/ui-jsx/shell/body`;
                },
                get isActive() {
                ...
                text: "Header",
                get href() {
                  return `/${locale()}/ui-jsx/shell/header`;
                },
                get isActive() {
                ...
                text: "HeaderGlobalAction",
                get href() {
                  return `/${locale()}/ui-jsx/shell/headerGlobalAction`;
                },
                get isActive() {
                ...
                text: "HeaderGlobalBar",
                get href() {
                  return `/${locale()}/ui-jsx/shell/headerGlobalBar`;
                },
                get isActive() {
                ...
                text: "HeaderHr",
                get href() {
                  return `/${locale()}/ui-jsx/shell/headerHr`;
                },
                get isActive() {
                ...
                text: "HeaderMenuButton",
                get href() {
                  return `/${locale()}/ui-jsx/shell/headerMenuButton`;
                },
                get isActive() {
                ...
                text: "HeaderMenuItem",
                get href() {
                  return `/${locale()}/ui-jsx/shell/headerMenuItem`;
                },
                get isActive() {
                ...
                text: "HeaderName",
                get href() {
                  return `/${locale()}/ui-jsx/shell/headerName`;
                },
                get isActive() {
                ...
                text: "HeaderNavigation",
                get href() {
                  return `/${locale()}/ui-jsx/shell/headerNavigation`;
                },
                get isActive() {
                ...
                text: "SubMenu",
                get href() {
                  return `/${locale()}/ui-jsx/shell/subMenu`;
                },
                get isActive() {
                ...
                text: "SubMenuItem",
                get href() {
                  return `/${locale()}/ui-jsx/shell/subMenuItem`;
                },
                get isActive() {
                ...
                text: "SideNav",
                get href() {
                  return `/${locale()}/ui-jsx/shell/sideNav`;
                },
                get isActive() {
                ...
                text: "SideNavItems",
                get href() {
                  return `/${locale()}/ui-jsx/shell/sideNavItems`;
                },
                get isActive() {
                ...
                text: "SideNavLink",
                get href() {
                  return `/${locale()}/ui-jsx/shell/sideNavLink`;
                },
                get isActive() {
                ...
                text: "SideNavMenu",
                get href() {
                  return `/${locale()}/ui-jsx/shell/sideNavMenu`;
                },
                get isActive() {
                ...
                text: "SideNavMenuItem",
                get href() {
                  return `/${locale()}/ui-jsx/shell/sideNavMenuItem`;
                },
                get isActive() {
            ...
            get menuName() {
              return m('sideNav.uiJSX.overlay.menuName');
            },
            defaultShow: true,
            get children() {
              return [Z(SideNavMenuItem, {
                text: "Tooltip",
                get href() {
                  return `/${locale()}/ui-jsx/overlay/tooltip`;
                },
                get isActive() {
                ...
                text: "Spinner",
                get href() {
                  return `/${locale()}/ui-jsx/overlay/spinner`;
                },
                get isActive() {
